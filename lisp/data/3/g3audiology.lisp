(defun g3audiology ()
  (data
    ...
    '(
      ...
      (f moderate f normal normal ? t ? f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f normal normal f f f normal t a f f f cochlear_unknown)
