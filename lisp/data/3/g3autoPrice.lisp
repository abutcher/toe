...
(defun g3autoPrice ()
  (data
    :name 'g3autoPrice
    :columns '($symboling $normalized-losses $wheel-base $length $width $height $curb-weight $engine-size $bore $stroke $compression-ratio $horsepower $peak-rpm $city-mpg $highway-mpg $class)
    :egs
    '(
      ...
      (-1 95 109.1 188.8 68.9 55.5 3062 141 3.78 3.15 9.5 114 5400 19 25 22625)
      )))
